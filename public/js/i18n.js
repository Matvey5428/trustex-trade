...
const i18n = {
  ...
  ru: {
    ...
    profileUsername: 'Юзернейм',
    profileBalances: 'Балансы',
    profileSettings: 'Настройки',
    profileAgreement: 'Соглашение',
    profileSupport: 'Связаться с поддержкой',
    requestVerification: 'Подать заявку на верификацию',
    accountId: 'ID аккаунта',
    statsLabel: 'Статистика (всего / прибыльных / убыточных)',
